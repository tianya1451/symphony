...
public final class Latkes {
    ...
    public static void init() {
        ...
        if (RuntimeMode.DEVELOPMENT == getRuntimeMode()) {
            LOGGER.warn("!!!!Runtime mode is [" + RuntimeMode.DEVELOPMENT + "], please make sure configured it with ["
                    + RuntimeMode.PRODUCTION + "] in latke.properties if deployed on production environment!!!!");
        } else {
